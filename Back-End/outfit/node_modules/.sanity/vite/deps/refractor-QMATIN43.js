...
function LazyRefractor(props) {
  ...
  let t2;
  $[6] !== language || $[7] !== registered || $[8] !== value ? (t2 = language && registered && (0, import_jsx_runtime.jsx)(import_react_refractor.default, { inline: true, language, value }), $[6] = language, $[7] = registered, $[8] = value, $[9] = t2) : t2 = $[9];
  let t3;
...
//# sourceMappingURL=refractor-QMATIN43.js.map
