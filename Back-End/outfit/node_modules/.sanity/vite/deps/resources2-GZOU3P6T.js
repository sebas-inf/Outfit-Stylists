...
var releasesLocaleStrings = {
  ...
  "archive-dialog.confirm-archive-header": "Are you sure you want to archive the '{{title}}' release?",
  ...
  "discard-version-dialog.description": "The '<strong>{{title}}</strong>' version of this document will be permanently deleted.",
  ...
  "schedule-dialog.confirm-title": "Are you sure you want to schedule the release and all document versions for publishing?",
  ...
  /** Description for the dialog confirming the publish of a release with multiple documents */
  "schedule-dialog.confirm-description_other": "The <strong>{{title}}</strong> release and its {{count}} document versions will be scheduled for publishing.",
...
//# sourceMappingURL=resources2-GZOU3P6T.js.map
