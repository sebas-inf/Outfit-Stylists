...
var rxjs = require("rxjs"), decode = require("./_chunks-cjs/decode.cjs"), mendoza = require("mendoza"), nanoid = require("nanoid"), utils = require("./_chunks-cjs/utils.cjs"), diffMatchPatch = require("@sanity/diff-match-patch"), getAtPath = require("./_chunks-cjs/getAtPath.cjs"), stringify = require("./_chunks-cjs/stringify.cjs"), groupBy = require("lodash/groupBy.js"), uuid = require("@sanity/uuid"), lodashPartition = require("lodash/partition.js"), operators = require("rxjs/operators"), keyBy = require("lodash/keyBy.js"), sortedIndex = require("lodash/sortedIndex.js");
function _interopDefaultCompat(e) {
  return e && typeof e == "object" && "default" in e ? e : { default: e };
}
var groupBy__default = /* @__PURE__ */ _interopDefaultCompat(groupBy), lodashPartition__default = /* @__PURE__ */ _interopDefaultCompat(lodashPartition), keyBy__default = /* @__PURE__ */ _interopDefaultCompat(keyBy), sortedIndex__default = /* @__PURE__ */ _interopDefaultCompat(sortedIndex);
...
function createOptimisticStore(backend) {
    ...
    return backend.listen(id).pipe(
      ...
      rxjs.mergeMap((event) => {
        ...
        if (event.type === "sync") {
          ...
          if (idx > -1)
            return pendingTransactions.splice(idx, 1), rxjs.EMPTY;
  ...
  return {
    ...
    submit: () => {
      ...
      return setPendingTransactions(transactions.map((t) => t.id)), rxjs.lastValueFrom(backend.submit(transactions).pipe(rxjs.toArray()));
    }
  };
}
