...
var main$1 = { exports: {} }, version = "16.4.7", require$$4 = {
  version
}, hasRequiredMain$1;
function requireMain$1() {
  if (hasRequiredMain$1) return main$1.exports;
  hasRequiredMain$1 = 1;
  const fs2 = require$$0__default$1.default, path2 = require$$0__default.default, os = require$$0__default$2.default, crypto = require$$3__default.default, version2 = require$$4.version, LINE = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
  function parse(src) {
    const obj = {};
...
var mainExports$1 = requireMain$1(), dotenv = /* @__PURE__ */ getDefaultExportFromCjs(mainExports$1), main = {}, hasRequiredMain;
...
function loadEnv(mode, envDir, prefixes = ["VITE_"]) {
  ...
  const env = {}, envFiles = [
    ...
    envFiles.flatMap((file) => {
      ...
      return envPath ? Object.entries(mainExports$1.parse(fs__default.default.readFileSync(envPath))) : [];
    })
  );
