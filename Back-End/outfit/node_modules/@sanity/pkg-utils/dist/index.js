...
function getExtractMessagesConfig(options) {
  ...
  return {
    ...
    extractorMessageReporting: {
      ...
      "ae-forgotten-export": {
        logLevel: ruleToLogLevel("ae-forgotten-export", "none"),
        addToApiReportFile: !1
      },
...
function resolveRollupConfig(ctx, buildTask) {
  const { format: format2, runtime, target } = buildTask, { config: config2, cwd, exports: _exports, external, distPath, logger, pkg, ts: ts2 } = ctx, isLegacyExports = buildTask.type === "build:legacy", outputExt = isLegacyExports ? pkgExtMap.legacy : pkgExtMap[pkg.type || "commonjs"][format2], minify = config2?.minify ?? !1, outDir = path.relative(cwd, distPath), pathAliases = Object.fromEntries(
    ...
    commonjs(),
    json(),
    (config2?.babel?.reactCompiler || config2?.babel?.styledComponents) && babel({
      babelrc: !1,
      ...
      plugins: [
        ...
        config2?.babel?.styledComponents && [
          "babel-plugin-styled-components",
          {
            ...
            cssProp: !1,
            ...typeof config2.babel.styledComponents == "object" ? config2.babel.styledComponents : {}
          }
        ],
        config2?.babel?.reactCompiler && [
          "babel-plugin-react-compiler",
          config2?.reactCompilerOptions || {}
        ]
      ].filter(Boolean)
    }),
    esbuild({
