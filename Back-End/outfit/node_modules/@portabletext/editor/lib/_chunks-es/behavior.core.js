import { isSelectionCollapsed, getCaretWordSelection, isSelectionExpanded, getFocusBlockObject, getNextBlock, getPreviousBlock, getFocusTextBlock, isAtTheEndOfBlock, getFocusSpan, isAtTheStartOfBlock, getFocusListBlock, getSelectedBlocks, createGuards } from "./selector.is-at-the-start-of-block.js";
...
const addAnnotationOnCollapsedSelection = {
  ...
  guard: ({
    ...
    if (!isSelectionCollapsed({
      ...
      return !1;
    const caretWordSelection = getCaretWordSelection({
      context
    });
