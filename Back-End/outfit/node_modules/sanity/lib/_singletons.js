...
}), IsLastPaneContext = _createContext.createContext("sanity/_singletons/context/is-last-pane", !1), LocaleContext = _createContext.createContext("sanity/_singletons/context/locale", void 0), MentionUserContext = _createContext.createContext("sanity/_singletons/context/mention-user", null), NavbarContext = _createContext.createContext("sanity/_singletons/context/navbar", {
...
const PaneRouterContext = _createContext.createContext("sanity/_singletons/context/pane-router", {
  ...
  selected: !1
}), ReferenceInputOptionsContext = _createContext.createContext("sanity/_singletons/context/reference-input-options", {}), ReferenceItemRefContext = _createContext.createContext("sanity/_singletons/context/reference-item-ref", null), ReleasesMetadataContext = _createContext.createContext("sanity/_singletons/context/releases-metadata", null), TableContext = _createContext.createContext("sanity/_singletons/context/releases-table", null), ReleasesUpsellContext = _createContext.createContext("sanity/_singletons/context/releases-upsell", null), ResourceCacheContext = _createContext.createContext("sanity/_singletons/context/resource-cache", null), ReviewChangesContext = _createContext.createContext("sanity/_singletons/context/review-changes", null), RouterContext = _createContext.createContext("sanity/_singletons/context/router", null), RouterHistoryContext = _createContext.createContext("sanity/_singletons/context/router-history", null), SanityCreateConfigContext = _createContext.createContext("sanity/_singletons/context/start-in-create-enabled", {
  startInCreateEnabled: !1
}), ScheduledPublishingEnabledContext = _createContext.createContext("sanity/_singletons/context/scheduled-publishing-enabled", null), SchedulePublishUpsellContext = _createContext.createContext("sanity/_singletons/context/schedule-publish-upsell", {
  upsellData: null,
...
}), SchedulesContext = _createContext.createContext("sanity/_singletons/context/schedules", void 0), ScrollContext = _createContext.createContext("sanity/_singletons/context/scroll", null), SearchContext = _createContext.createContext("sanity/_singletons/context/search", void 0), SortableItemIdContext = _createContext.createContext("sanity/_singletons/context/sortable-item-id", null), SourceContext = _createContext.createContext("sanity/_singletons/context/source", null), StructureToolContext = _createContext.createContext("sanity/_singletons/context/structure-tool", null), StudioAnnouncementContext = _createContext.createContext("sanity/_singletons/context/studioAnnouncements", void 0), TasksContext = _createContext.createContext("sanity/_singletons/context/tasks", null), TasksEnabledContext = _createContext.createContext("sanity/_singletons/context/tasks-enabled", {
  enabled: !1,
  mode: null
