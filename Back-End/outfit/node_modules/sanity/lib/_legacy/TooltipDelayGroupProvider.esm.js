...
import { Button as Button$1, Flex, Dialog as Dialog$1, Box, ErrorBoundary as ErrorBoundary$1, MenuButton as MenuButton$1, Hotkeys as Hotkeys$1, Text, Badge, Stack, MenuItem as MenuItem$1, Popover as Popover$1, Tab as Tab$1, Tooltip as Tooltip$1, TooltipDelayGroupProvider as TooltipDelayGroupProvider$1 } from "@sanity/ui";
import { forwardRef, useContext, isValidElement } from "react";
import { SourceContext } from "../_singletons.esm.js";
...
`, Button = forwardRef(function(t0, ref) {
  ...
  let t2;
  $[6] !== footer || $[7] !== props || $[8] !== t ? (t2 = (footer?.confirmButton || footer?.cancelButton) && /* @__PURE__ */ jsxs(Flex, { width: "full", gap: 3, justify: "flex-end", padding: 3, children: [
...
//# sourceMappingURL=TooltipDelayGroupProvider.esm.js.map
