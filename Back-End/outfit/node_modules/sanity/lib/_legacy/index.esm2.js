...
import { Button } from "./TooltipDelayGroupProvider.esm.js";
import "../_singletons.esm.js";
import { usePaneLayout, PaneContent, PaneItem, useStructureTool, usePane, PaneHeader, PaneHeaderActions, BackLink, Pane, _DEBUG } from "./pane.esm.js";
...
function ListPaneContent(props) {
  ...
  $[6] !== childItemId || $[7] !== getI18nText || $[8] !== isActive || $[9] !== layout || $[10] !== shouldShowIconForItem ? (t3 = (item_1, ctx) => {
    ...
    if (item_1.type === "divider")
      return /* @__PURE__ */ jsx(Box, { marginBottom: 1, children: /* @__PURE__ */ jsx(Divider, {}) }, `divider-${itemIndex_0}`);
