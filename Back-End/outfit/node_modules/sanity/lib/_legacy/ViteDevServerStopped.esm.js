...
const serverHot = import.meta.hot, isViteServer = (hot) => !!hot, useDetectViteDevServerStopped = () => {
  ...
  return null;
}, DetectViteDevServerStopped = () => isViteServer(serverHot) ? /* @__PURE__ */ jsx(ThrowViteServerStopped, {}) : null, DevServerStoppedErrorScreen = () => /* @__PURE__ */ jsx(Card, { height: "fill", overflow: "auto", paddingY: [4, 5, 6, 7], paddingX: 4, sizing: "border", tone: "critical", children: /* @__PURE__ */ jsx(Container, { width: 3, children: /* @__PURE__ */ jsxs(Stack, { space: 4, children: [
  /* @__PURE__ */ jsx(Heading, { children: ERROR_TITLE }),
...
//# sourceMappingURL=ViteDevServerStopped.esm.js.map
