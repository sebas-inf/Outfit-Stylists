...
const PostMessageFeatures = (props) => {
  ...
  let t0, t1;
  return $[0] !== comlink ? (t0 = () => comlink.on("visual-editing/features", _temp$7), t1 = [comlink], $[0] = comlink, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), useEffect(t0, t1), null;
};
...
function usePanelsStorage() {
  const $ = c(1);
  let t0;
  const get = _temp2$3, set = _temp3$2;
  let t1;
...
function _temp2$3(panels) {
  const stored = getStoredItem(), key = getKeyForPanels(panels);
  return Array.isArray(stored[key]) && stored[key].some(_temp$6) ? void 0 : stored[key];
}
function _temp$6(val) {
  return val === null;
}
...
function PresentationPaneRouterProvider(props) {
  ...
  $[16] !== createPathWithParams || $[17] !== t4 || $[18] !== t6 || $[19] !== t7 || $[20] !== t8 || $[21] !== t9 ? (t10 = {
    ...
    ParameterizedLink: _temp$5,
    closeCurrentAndAfter: _temp2$2,
...
function DocumentListPane(props) {
  ...
  if ($[0] !== mainDocumentState?.document?._id || $[1] !== refs) {
    let t22;
    $[3] !== mainDocumentState?.document?._id ? (t22 = (r) => getPublishedId(r._id) !== mainDocumentState?.document?._id, $[3] = mainDocumentState?.document?._id, $[4] = t22) : t22 = $[4], t1 = refs.filter(t22).map(_temp$4), $[0] = mainDocumentState?.document?._id, $[1] = refs, $[2] = t1;
  } else
    t1 = $[2];
  t0 = t1;
  const ids = t0;
  ...
  const handleRetry = t6, [structureParams] = useState(_temp2$1);
  let t7;
...
function ContentEditor(props) {
  ...
  bb0: {
    ...
    let t52;
    $[7] !== previewState.draft || $[8] !== previewState.published || $[9] !== t42 ? (t52 = getPreviewValueWithFallback({
      value: t42,
    ...
    let t7;
    $[13] !== t62 ? (t7 = /* @__PURE__ */ jsx(Card, { padding: 1, radius: 2, shadow: 1, children: /* @__PURE__ */ jsx(Text, { muted: !0, size: 0, weight: "medium", children: t62 }) }), $[13] = t62, $[14] = t7) : t7 = $[14];
    let t8;
    $[15] !== schemaType2 || $[16] !== t52 || $[17] !== t7 ? (t8 = /* @__PURE__ */ jsx(SanityDefaultPreview, { ...t52, schemaType: schemaType2, status: t7 }), $[15] = schemaType2, $[16] = t52, $[17] = t7, $[18] = t8) : t8 = $[18], t3 = t8;
  }
  const preview = t3;
  if (documentId && documentType) {
    let t42;
    return $[19] !== documentId || $[20] !== documentType || $[21] !== onFocusPath || $[22] !== onStructureParams || $[23] !== searchParams || $[24] !== structureParams ? (t42 = /* @__PURE__ */ jsx(DocumentPanel, { documentId, documentType, onFocusPath, onStructureParams, searchParams, structureParams }), $[19] = documentId, $[20] = documentType, $[21] = onFocusPath, $[22] = onStructureParams, $[23] = searchParams, $[24] = structureParams, $[25] = t42) : t42 = $[25], t42;
  }
  let t4;
  ...
  let t5;
  $[31] !== mainDocumentState || $[32] !== onStructureParams || $[33] !== refs || $[34] !== searchParams ? (t5 = /* @__PURE__ */ jsx(DocumentListPane, { mainDocumentState, onStructureParams, searchParams, refs }), $[31] = mainDocumentState, $[32] = onStructureParams, $[33] = refs, $[34] = searchParams, $[35] = t5) : t5 = $[35];
  let t6;
  return $[36] !== t4 || $[37] !== t5 ? (t6 = /* @__PURE__ */ jsxs(Flex, { direction: "column", flex: 1, height: "fill", children: [
    t4,
    t5
...
function usePresentationNavigator(props) {
  ...
  bb0: {
    ...
    let t12;
    $[0] !== setNavigatorEnabled ? (t12 = () => setNavigatorEnabled(_temp$3), $[0] = setNavigatorEnabled, $[1] = t12) : t12 = $[1], t0 = t12;
  }
...
function PreviewHeader(props) {
  const $ = c(7), renderDefault = _temp$2, HeaderComponent = props.options?.component;
  let t0;
...
function _temp$2(props_0) {
  return /* @__PURE__ */ jsx(PreviewHeaderDefault, { ...props_0 });
}
function usePresentationPreviewHeader(props) {
  const $ = c(2);
  let t0;
  return $[0] !== props ? (t0 = () => /* @__PURE__ */ jsx(PreviewHeader, { ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
}
const MotionFlex = motion.create(Flex), Preview = memo(forwardRef(function(props, forwardedRef) {
  ...
  const {
    ...
    devMode
  } = usePresentationTool(), prefersReducedMotion = usePrefersReducedMotion(), ref = useRef(null), PreviewHeader2 = usePresentationPreviewHeader({
    ...props,
    iframeRef: ref,
    options: header
  });
...
function useMainDocument(props) {
  const {
    ...
    state: routerState
  } = useRouter(), client = useClient({
    apiVersion: API_VERSION
  }), relativeUrl = path || routerState._searchParams?.find(([key]) => key === "preview")?.[1] || "", [mainDocumentState, setMainDocumentState] = useState(void 0), mainDocumentIdRef = useRef(void 0), handleResponse = useEffectEvent((doc, url) => {
  ...
  return useEffect(() => {
    const base = (
      ...
      typeof previewUrl == "string" ? previewUrl : typeof previewUrl == "object" && previewUrl?.origin || location.origin
    ), url_0 = new URL(relativeUrl, base);
    if (resolvers.length) {
      let result;
  ...
  }, [client, handleResponse, previewUrl, relativeUrl, resolvers]), mainDocumentState;
}
...
function PresentationTool(props) {
  ...
  }, [controller, handleNavigate, setDocumentsOnPage, setOverlaysConnection, targetOrigin]), useEffect(() => {
    if (!controller) return;
