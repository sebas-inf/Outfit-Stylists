...
import { useState, useEffect, memo, lazy, Suspense, Fragment } from "react";
import { isRecord, useDocumentStore, useTranslation, Translate, usePerspective, useEditState, useSchema, unstable_useValuePreview, _isCustomDocumentTypeDefinition, useWorkspace, SourceProvider } from "sanity";
import { Button, ErrorBoundary } from "./TooltipDelayGroupProvider.esm.js";
import { usePaneLayout, BackLink, ParameterizedLink, ReferenceChildLink, ChildLink, useStructureTool, LOADING_PANE, structureLocaleNamespace, SerializeError, Pane, PaneHeader, PaneContent, LoadingPane, PaneLayout, setActivePanes, StructureToolProvider } from "./pane.esm.js";
...
import { generateHelpUrl } from "./generate-help-url.esm.esm.js";
...
function UnknownPane(props) {
  ...
  let t2;
  $[4] !== t1 ? (t2 = /* @__PURE__ */ jsx(PaneHeader, { title: t1 }), $[4] = t1, $[5] = t2) : t2 = $[5];
  let t3;
...
const paneMap = {
  ...
  let t2;
  $[4] !== PaneComponent || $[5] !== active || $[6] !== index || $[7] !== itemId || $[8] !== pane || $[9] !== paneKey || $[10] !== selected || $[11] !== t1 ? (t2 = /* @__PURE__ */ jsx(PaneComponent, { childItemId: t1, index, itemId, isActive: active, isSelected: selected, paneKey, pane }), $[4] = PaneComponent, $[5] = active, $[6] = index, $[7] = itemId, $[8] = pane, $[9] = paneKey, $[10] = selected, $[11] = t1, $[12] = t2) : t2 = $[12];
  let t3;
...
`, isSaveHotkey = isHotkey("mod+s"), StructureTool = memo(function(t0) {
  ...
  let t13;
  $[17] !== handleRootCollapse || $[18] !== handleRootExpand || $[19] !== t10 || $[20] !== t11 || $[21] !== t12 || $[22] !== t9 ? (t13 = /* @__PURE__ */ jsxs(StyledPaneLayout, { flex: 1, height: t9, minWidth: t10, onCollapse: handleRootCollapse, onExpand: handleRootExpand, children: [
    t11,
    t12
