...
import {ReleaseId} from '@sanity/client'
...
declare interface DocumentStatusProps {
  ...
  versions?:
    ...
    | Record<
        string,
        {
          snapshot: DocumentStatusProps['draft']
        }
      >
  singleLine?: boolean
}
 ...
 *@internal
 */
declare type ReleaseState = 'active' | 'archived' | 'published' | 'scheduled' | 'scheduling'
...
declare const studioLocaleStrings: {
  ...
  'release.action.discard-version.success': string
  ...
  'release.form.placeholer-describe-release': string
 ...
 * @internal
 */
export declare const VersionInlineBadge: IStyledComponentBase<
  'web',
  Substitute<
 ...
 * @internal
 */
declare type VersionsRecord = Record<string, PreparedSnapshot>
