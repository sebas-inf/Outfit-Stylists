...
function PaneItemPreview(props) {
  const $ = reactCompilerRuntime.c(33), {
    ...
    schemaType,
    value
  } = props, title = sanity.isRecord(value.title) && React.isValidElement(value.title) || isString__default.default(value.title) || isNumber__default.default(value.title) ? value.title : null, {
    data,
    loading
  } = sanity.useActiveReleases(), {
    releasesIds
  } = sanity.useReleasesIds(data), {
    perspectiveStack,
    selectedPerspectiveName
  } = sanity.usePerspective();
  let t0, t1;
  $[0] !== perspectiveStack || $[1] !== props.documentPreviewStore || $[2] !== releasesIds || $[3] !== schemaType || $[4] !== title || $[5] !== value._id ? (t1 = sanity.getPreviewStateObservable(props.documentPreviewStore, schemaType, value._id, title, {
    ids: releasesIds,
  ...
  } = reactRx.useObservable(previewStateObservable, t3), isLoading = previewIsLoading || loading;
  let t4;
  $[10] !== draft || $[11] !== isLoading || $[12] !== presence || $[13] !== published || $[14] !== versions ? (t4 = isLoading ? null : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    presence && presence.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentPreviewPresence, { presence }),
    /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatusIndicator, { draft, published, versions })
  ] }) }), $[10] = draft, $[11] = isLoading, $[12] = presence, $[13] = published, $[14] = versions, $[15] = t4) : t4 = $[15];
  const status = t4;
  let t5;
  $[16] !== draft || $[17] !== published || $[18] !== versions ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatus, { draft, published, versions }), $[16] = draft, $[17] = published, $[18] = versions, $[19] = t5) : t5 = $[19];
  const tooltip = t5;
  let t6;
  $[20] !== draft || $[21] !== published || $[22] !== selectedPerspectiveName || $[23] !== value || $[24] !== version ? (t6 = sanity.getPreviewValueWithFallback({
    value,
    draft,
    published,
    version,
  ...
  let t7;
  return $[26] !== icon || $[27] !== isLoading || $[28] !== layout || $[29] !== status || $[30] !== t6 || $[31] !== tooltip ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { ...t6, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[26] = icon, $[27] = isLoading, $[28] = layout, $[29] = status, $[30] = t6, $[31] = tooltip, $[32] = t7) : t7 = $[32], t7;
}
...
const ChildLink = React.forwardRef(function(props, ref) {
  ...
  let t3;
  return $[15] !== ref || $[16] !== rest || $[17] !== t2 ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(router$1.StateLink, { ...rest, ref, state: t2 }), $[15] = ref, $[16] = rest, $[17] = t2, $[18] = t3) : t3 = $[18], t3;
  ...
  const nextState = t0;
  let t11;
  return $[30] !== nextState || $[31] !== ref || $[32] !== rest ? (t11 = /* @__PURE__ */ jsxRuntime.jsx(router$1.StateLink, { ref, ...rest, state: nextState }), $[30] = nextState, $[31] = ref, $[32] = rest, $[33] = t11) : t11 = $[33], t11;
    ...
    $[43] !== documentTitle ? (t162 = {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(ui.Box, { overflow: "auto", paddingTop: 2, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(Table$1, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: crossDatasetReferences.references.filter(_temp$l).map((t172, index) => {
            const {
              projectId,
              datasetName,
              documentId
...
function useReferringDocuments(documentId) {
  ...
  let t5;
  $[8] !== crossDatasetReferences?.references ? (t5 = () => Array.from(new Set(crossDatasetReferences?.references.map(_temp$k).filter(Boolean))).sort(), $[8] = crossDatasetReferences?.references, $[9] = t5) : t5 = $[9];
  let t6;
  $[10] !== t5 ? (t6 = t5(), $[10] = t5, $[11] = t6) : t6 = $[11];
  const projectIds = t6;
  let t7, t8;
  $[12] !== crossDatasetReferences?.references ? (t8 = Array.from(new Set(crossDatasetReferences?.references.map(_temp2$8).filter(_temp3$2))).sort(), $[12] = crossDatasetReferences?.references, $[13] = t8) : t8 = $[13], t7 = t8;
...
`, TitleText = styledComponents.styled(ui.Text)`
  cursor: default;
  outline: none;
`, TabsBox = styledComponents.styled(ui.Box)(({
  theme: theme2
}) => {
  const {
    color,
  ...
  let t8;
  $[8] !== backButton ? (t8 = backButton && /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: backButton }), $[8] = backButton, $[9] = t8) : t8 = $[9];
  const t9 = backButton ? 1 : 2;
  let t10;
  $[10] !== loading ? (t10 = loading && /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { padding: 2, children: /* @__PURE__ */ jsxRuntime.jsx(TitleTextSkeleton, { animated: !0, radius: 1, size: 1 }) }), $[10] = loading, $[11] = t10) : t10 = $[11];
  let t11;
  $[12] !== loading || $[13] !== title ? (t11 = !loading && /* @__PURE__ */ jsxRuntime.jsx(TitleText, { size: 1, textOverflow: "ellipsis", weight: "semibold", children: title }), $[12] = loading, $[13] = title, $[14] = t11) : t11 = $[14];
  let t12;
  $[15] !== handleTitleClick || $[16] !== t10 || $[17] !== t11 || $[18] !== t9 || $[19] !== tabIndex ? (t12 = /* @__PURE__ */ jsxRuntime.jsxs(TitleCard, { __unstable_focusRing: !0, flex: 1, onClick: handleTitleClick, paddingLeft: t9, padding: 2, tabIndex, children: [
    t10,
    t11
  ] }), $[15] = handleTitleClick, $[16] = t10, $[17] = t11, $[18] = t9, $[19] = tabIndex, $[20] = t12) : t12 = $[20];
  let t13;
  $[21] !== actions || $[22] !== collapsed ? (t13 = actions && /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { hidden: collapsed, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.LegacyLayerProvider, { zOffset: "paneHeader", children: actions }) }), $[21] = actions, $[22] = collapsed, $[23] = t13) : t13 = $[23];
  let t14;
  $[24] !== handleLayoutClick || $[25] !== layoutStyle || $[26] !== t12 || $[27] !== t13 || $[28] !== t7 || $[29] !== t8 ? (t14 = /* @__PURE__ */ jsxRuntime.jsxs(Layout, { gap: 1, onClick: handleLayoutClick, padding: 3, paddingBottom: t7, sizing: "border", style: layoutStyle, children: [
    t8,
    t12,
    t13
  ] }), $[24] = handleLayoutClick, $[25] = layoutStyle, $[26] = t12, $[27] = t13, $[28] = t7, $[29] = t8, $[30] = t14) : t14 = $[30];
  let t15;
  $[31] !== collapsed || $[32] !== showTabsOrSubActions || $[33] !== subActions || $[34] !== tabs ? (t15 = showTabsOrSubActions && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", hidden: collapsed, overflow: "auto", paddingBottom: 3, paddingX: 3, children: [
  ...
  let t17;
  $[36] !== t14 || $[37] !== t15 || $[38] !== t16 || $[39] !== t6 ? (t17 = /* @__PURE__ */ jsxRuntime.jsx(sanity.LegacyLayerProvider, { zOffset: "paneHeader", children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Card, { "data-collapsed": t6, tone: "inherit", children: [
    t14,
    t15,
    t16
  ] }) }), $[36] = t14, $[37] = t15, $[38] = t16, $[39] = t6, $[40] = t17) : t17 = $[40];
  let t18;
  return $[41] !== border || $[42] !== ref || $[43] !== t17 || $[44] !== t5 ? (t18 = /* @__PURE__ */ jsxRuntime.jsx(ui.LayerProvider, { zOffset: 100, children: /* @__PURE__ */ jsxRuntime.jsx(Root$5, { $border: border, "data-collapsed": t5, "data-testid": "pane-header", ref, children: t17 }) }), $[41] = border, $[42] = ref, $[43] = t17, $[44] = t5, $[45] = t18) : t18 = $[45], t18;
});
...
function PaneLayout(props) {
  ...
  const [controller] = React.useState(_temp$j), [rootElement, setRootElement] = React.useState(null), width = ui.useElementRect(rootElement)?.width || 0, collapsed = width === void 0 || !minWidth ? void 0 : width < minWidth;
  let t0;
...
const IntentButton = React.forwardRef(function(props, ref) {
  ...
  const Link = t0;
  let t2;
  return $[7] !== Link || $[8] !== props.disabled || $[9] !== ref || $[10] !== restProps ? (t2 = props.disabled ? /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...restProps, as: "a", role: "link", "aria-disabled": "true" }) : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { ...restProps, as: Link, "data-as": "a", ref }), $[7] = Link, $[8] = props.disabled, $[9] = ref, $[10] = restProps, $[11] = t2) : t2 = $[11], t2;
});
...
function PaneHeaderCreateButton(t0) {
  ...
  let t3;
  t3 = !isTemplatePermissionsLoading && templatePermissions?.every(_temp$i);
  ...
  if (templateItems.length === 1) {
    ...
    const t72 = firstItem.icon || icons.AddIcon;
    let t82;
    ...
    let t92;
    $[26] !== disabled || $[27] !== intent || $[28] !== t62.title || $[29] !== t72 || $[30] !== t82 ? (t92 = /* @__PURE__ */ jsxRuntime.jsx(IntentButton, { "aria-label": t62.title, icon: t72, intent, mode: "bleed", disabled, "data-testid": "action-intent-button", tooltipProps: t82 }), $[26] = disabled, $[27] = intent, $[28] = t62.title, $[29] = t72, $[30] = t82, $[31] = t92) : t92 = $[31];
    let t102;
    return $[32] !== disabled || $[33] !== isTemplatePermissionsLoading || $[34] !== t92 ? (t102 = /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionsMessageTooltip, { reveal: disabled, loading: isTemplatePermissionsLoading, context: "create-document-type", children: t92 }), $[32] = disabled, $[33] = isTemplatePermissionsLoading, $[34] = t92, $[35] = t102) : t102 = $[35], t102;
  }
  ...
  let t7;
  $[40] !== t5 || $[41] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { icon: icons.AddIcon, mode: "bleed", disabled: t5, "data-testid": "multi-action-intent-button", tooltipProps: t6 }), $[40] = t5, $[41] = t6, $[42] = t7) : t7 = $[42];
  let t8;
  if ($[43] !== getI18nText || $[44] !== isTemplatePermissionsLoading || $[45] !== permissionsById || $[46] !== selectedReleaseId || $[47] !== t || $[48] !== templateItems || $[49] !== templates) {
    ...
    $[51] !== getI18nText || $[52] !== isTemplatePermissionsLoading || $[53] !== permissionsById || $[54] !== selectedReleaseId || $[55] !== t || $[56] !== templates ? (t92 = (item, itemIndex) => {
      ...
      if (!template || !intent_0)
        return null;
      const Link = React.forwardRef((linkProps, linkRef) => disabled_0 ? /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", disabled: !0, ...linkProps, ref: linkRef }) : /* @__PURE__ */ jsxRuntime.jsx(router$1.IntentLink, { ...linkProps, intent: intent_0.type, params: intent_0.params, searchParams: intent_0.searchParams, ref: linkRef }));
    ...
    t8 = $[50];
  let t9;
  $[58] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(ui.Menu, { children: t8 }), $[58] = t8, $[59] = t9) : t9 = $[59];
  let t10;
  return $[60] !== t7 || $[61] !== t9 ? (t10 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuButton, { button: t7, id: "create-menu", menu: t9, popover: POPOVER_PROPS }), $[60] = t7, $[61] = t9, $[62] = t10) : t10 = $[62], t10;
}
...
function MissingSchemaType(props) {
  ...
  let t6;
  return $[12] !== layout || $[13] !== t2 || $[14] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { title: t2, subtitle: t5, media: _temp$h, layout }), $[12] = layout, $[13] = t2, $[14] = t5, $[15] = t6) : t6 = $[15], t6;
}
function _temp$h() {
...
function PreloadDocumentPane(props) {
  ...
  return sanity.useEditState(documentId, documentType), null;
}
...
function Banner(props) {
  ...
  let t3;
  $[9] !== content ? (t3 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", flex: 1, gap: 2, paddingY: 3, children: content }), $[9] = content, $[10] = t3) : t3 = $[10];
  let t4;
  ...
  let t5;
  $[13] !== t2 || $[14] !== t3 || $[15] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    t2,
    t3,
    t4
  ] }), $[13] = t2, $[14] = t3, $[15] = t4, $[16] = t5) : t5 = $[16];
  let t6;
  return $[17] !== paddingY || $[18] !== rest || $[19] !== t5 || $[20] !== tone ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { borderBottom: !0, paddingX: 4, paddingY, tone, ...rest, children: t5 }), $[17] = paddingY, $[18] = rest, $[19] = t5, $[20] = tone, $[21] = t6) : t6 = $[21], t6;
}
...
function AddToReleaseBanner(t0) {
  ...
  const tone = t2, {
    ...
    createVersion
  } = sanity.useVersionOperations();
  let t3;
  $[2] !== createVersion || $[3] !== currentRelease._id || $[4] !== documentId || $[5] !== value ? (t3 = async () => {
    currentRelease._id && await createVersion(sanity.getReleaseIdFromReleaseDocumentId(currentRelease._id), documentId, value);
  }, $[2] = createVersion, $[3] = currentRelease._id, $[4] = documentId, $[5] = value, $[6] = t3) : t3 = $[6];
  const handleAddToRelease = t3;
  let t4;
  $[7] !== currentRelease.metadata?.title || $[8] !== tCore ? (t4 = currentRelease?.metadata?.title || tCore("release.placeholder-untitled-release"), $[7] = currentRelease.metadata?.title, $[8] = tCore, $[9] = t4) : t4 = $[9];
  let t5;
  $[10] !== t4 ? (t5 = {
    title: t4
  }, $[10] = t4, $[11] = t5) : t5 = $[11];
  ...
  let t7;
  $[14] !== t || $[15] !== t5 || $[16] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { i18nKey: "banners.release.not-in-release", t, values: t5, components: t6 }) }), $[14] = t, $[15] = t5, $[16] = t6, $[17] = t7) : t7 = $[17];
  let t8;
  $[18] !== t ? (t8 = t("banners.release.action.add-to-release"), $[18] = t, $[19] = t8) : t8 = $[19];
  let t9;
  $[20] !== handleAddToRelease || $[21] !== t8 || $[22] !== tone ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { text: t8, tone, onClick: handleAddToRelease }), $[20] = handleAddToRelease, $[21] = t8, $[22] = tone, $[23] = t9) : t9 = $[23];
  let t10;
  $[24] !== t7 || $[25] !== t9 ? (t10 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: [
    t7,
    t9
  ] }), $[24] = t7, $[25] = t9, $[26] = t10) : t10 = $[26];
  let t11;
  return $[27] !== t10 || $[28] !== tone ? (t11 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone, paddingY: 0, content: t10 }), $[27] = t10, $[28] = tone, $[29] = t11) : t11 = $[29], t11;
}
function ArchivedReleaseDocumentBanner() {
  ...
  if ($[3] !== archivedReleases || $[4] !== params?.historyVersion) {
    let t32;
    $[6] !== params?.historyVersion ? (t32 = (r) => sanity.getReleaseIdFromReleaseDocumentId(r._id) === params?.historyVersion, $[6] = params?.historyVersion, $[7] = t32) : t32 = $[7], t2 = archivedReleases.find(t32), $[3] = archivedReleases, $[4] = params?.historyVersion, $[5] = t2;
  } else
    t2 = $[5];
  t1 = t2;
  const release = t1, description = release?.state === "published" ? "banners.published-release.description" : "banners.archived-release.description";
  let t3;
  $[8] !== release ? (t3 = {
    VersionBadge: (t42) => {
      const {
      ...
      return release ? /* @__PURE__ */ jsxRuntime.jsx(sanity.VersionInlineBadge, { $tone: sanity.getReleaseTone(release), children: release?.metadata.title }) : children;
    }
  }, $[8] = release, $[9] = t3) : t3 = $[9];
  let t4;
  $[10] !== description || $[11] !== t || $[12] !== t3 ? (t4 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", justify: "space-between", gap: 1, flex: 1, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { t, i18nKey: description, components: t3 }) }) }), $[10] = description, $[11] = t, $[12] = t3, $[13] = t4) : t4 = $[13];
  let t5;
  $[14] !== handleGoBack ? (t5 = {
    text: "Go back to published version",
    onClick: handleGoBack
  }, $[14] = handleGoBack, $[15] = t5) : t5 = $[15];
  let t6;
  return $[16] !== t4 || $[17] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone: "caution", paddingY: 2, content: t4, action: t5 }), $[16] = t4, $[17] = t5, $[18] = t6) : t6 = $[18], t6;
}
...
function DraftLiveEditBanner(t0) {
  ...
  let t14;
  return $[34] !== t13 || $[35] !== t5 || $[36] !== t9 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(Banner, { paddingY: 0, content: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", justify: "space-between", gap: 2, paddingTop: 1, children: [
    t5,
    t9,
    t13
...
const preventDefault = (ev) => ev.preventDefault(), FormView = React.forwardRef(function(props, ref) {
  ...
  }, t8 = [handleInitialValue, hasRev], $[23] = handleInitialValue, $[24] = hasRev, $[25] = t7, $[26] = t8) : (t7 = $[25], t8 = $[26]), React.useEffect(t7, t8);
  const [formRef, setFormRef] = React.useState(null), [focusedFirstDescendant, setFocusedFirstDescendant] = React.useState(!1);
  let t9;
  $[27] !== focusedFirstDescendant || $[28] !== formRef || $[29] !== formState?.focusPath.length || $[30] !== ready ? (t9 = () => {
  ...
  }, $[27] = focusedFirstDescendant, $[28] = formRef, $[29] = formState?.focusPath.length, $[30] = ready, $[31] = t9) : t9 = $[31];
  const t10 = formState?.focusPath.length;
  let t11;
  $[32] !== focusedFirstDescendant || $[33] !== formRef || $[34] !== ready || $[35] !== t10 ? (t11 = [focusedFirstDescendant, formRef, t10, ready], $[32] = focusedFirstDescendant, $[33] = formRef, $[34] = ready, $[35] = t10, $[36] = t11) : t11 = $[36], React.useEffect(t9, t11);
  let t12;
  $[37] !== ref ? (t12 = (node) => {
    setFormRef(node), typeof ref == "function" ? ref(node) : ref && (ref.current = node);
  }, $[37] = ref, $[38] = t12) : t12 = $[38];
  const setRef = t12;
  let t13;
  $[39] !== collapsedFieldSets || $[40] !== collapsedPaths || $[41] !== connectionState || $[42] !== documentId || $[43] !== editState?.draft || $[44] !== editState?.published || $[45] !== editState?.ready || $[46] !== fieldActions || $[47] !== formState || $[48] !== hidden || $[49] !== onBlur || $[50] !== onChange || $[51] !== onFocus || $[52] !== onPathOpen || $[53] !== onSetActiveFieldGroup || $[54] !== onSetCollapsedFieldSet || $[55] !== onSetCollapsedPath || $[56] !== openPath || $[57] !== patchChannel || $[58] !== presence || $[59] !== t || $[60] !== title || $[61] !== validation ? (t13 = connectionState === "connecting" && !editState?.draft && !editState?.published ? /* @__PURE__ */ jsxRuntime.jsx(Delay, { ms: 300, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", direction: "column", height: "fill", justify: "center", children: [
  ...
  ] }), $[39] = collapsedFieldSets, $[40] = collapsedPaths, $[41] = connectionState, $[42] = documentId, $[43] = editState?.draft, $[44] = editState?.published, $[45] = editState?.ready, $[46] = fieldActions, $[47] = formState, $[48] = hidden, $[49] = onBlur, $[50] = onChange, $[51] = onFocus, $[52] = onPathOpen, $[53] = onSetActiveFieldGroup, $[54] = onSetCollapsedFieldSet, $[55] = onSetCollapsedPath, $[56] = openPath, $[57] = patchChannel, $[58] = presence, $[59] = t, $[60] = title, $[61] = validation, $[62] = t13) : t13 = $[62];
  let t14;
  $[63] !== setRef || $[64] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { as: "form", onSubmit: preventDefault, ref: setRef, children: t13 }), $[63] = setRef, $[64] = t13, $[65] = t14) : t14 = $[65];
  let t15;
  $[66] !== margins || $[67] !== t14 ? (t15 = /* @__PURE__ */ jsxRuntime.jsx(sanity.PresenceOverlay, { margins, children: t14 }), $[66] = margins, $[67] = t14, $[68] = t15) : t15 = $[68];
  let t16;
  return $[69] !== hidden || $[70] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Container, { hidden, paddingX: 4, paddingTop: 5, paddingBottom: 9, sizing: "border", width: 1, children: t15 }), $[69] = hidden, $[70] = t15, $[71] = t16) : t16 = $[71], t16;
});
...
const DocumentBox = styledComponents.styled(ui.Box)({
  ...
  let t3;
  $[7] !== activeView.component || $[8] !== activeView.options || $[9] !== activeView.type || $[10] !== displayed || $[11] !== documentId || $[12] !== editState?.draft || $[13] !== editState?.published || $[14] !== schemaType || $[15] !== value ? (t3 = () => {
    ...
    return !1;
  }, $[7] = activeView.component, $[8] = activeView.options, $[9] = activeView.type, $[10] = displayed, $[11] = documentId, $[12] = editState?.draft, $[13] = editState?.published, $[14] = schemaType, $[15] = value, $[16] = t3) : t3 = $[16];
  let t4;
  ...
  let t6;
  $[21] !== documentId || $[22] !== documentScrollElement ? (t6 = [documentId, documentScrollElement], $[21] = documentId, $[22] = documentScrollElement, $[23] = t6) : t6 = $[23], React.useEffect(t5, t6);
  let t7, t8;
  $[24] !== portalElement || $[25] !== setDocumentPanelPortalElement ? (t7 = () => {
    portalElement && setDocumentPanelPortalElement(portalElement);
  }, t8 = [portalElement, setDocumentPanelPortalElement], $[24] = portalElement, $[25] = setDocumentPanelPortalElement, $[26] = t7, $[27] = t8) : (t7 = $[26], t8 = $[27]), React.useEffect(t7, t8);
  let t9, t10;
  $[28] !== displayed || $[29] !== isInspectOpen || $[30] !== value ? (t10 = isInspectOpen ? /* @__PURE__ */ jsxRuntime.jsx(InspectDialog, { value: displayed || value }) : null, $[28] = displayed, $[29] = isInspectOpen, $[30] = value, $[31] = t10) : t10 = $[31], t9 = t10;
  ...
  bb1: {
    if (params?.historyVersion) {
      let t123;
      $[32] === Symbol.for("react.memo_cache_sentinel") ? (t123 = /* @__PURE__ */ jsxRuntime.jsx(ArchivedReleaseDocumentBanner, {}), $[32] = t123) : t123 = $[32], t11 = t123;
      break bb1;
    }
    ...
    if (sanity.isReleaseDocument(selectedPerspective) && sanity.isReleaseScheduledOrScheduling(selectedPerspective)) {
      ...
      let t133;
      $[33] !== t123 ? (t133 = /* @__PURE__ */ jsxRuntime.jsx(ScheduledReleaseBanner, { currentRelease: t123 }), $[33] = t123, $[34] = t133) : t133 = $[34], t11 = t133;
      break bb1;
    }
    if (displayed?._id && sanity.getVersionFromId(displayed._id) !== selectedReleaseId && ready && !isCreatingDocument) {
      const t123 = selectedPerspective, t133 = displayed || void 0;
      let t143;
      $[35] !== t123 || $[36] !== t133 || $[37] !== value._id ? (t143 = /* @__PURE__ */ jsxRuntime.jsx(AddToReleaseBanner, { documentId: value._id, currentRelease: t123, value: t133 }), $[35] = t123, $[36] = t133, $[37] = value._id, $[38] = t143) : t143 = $[38], t11 = t143;
      break bb1;
    }
    if (activeView.type === "form" && isLiveEdit && ready && editState?.draft?._id && !selectedReleaseId) {
      let t123;
      $[39] !== displayed || $[40] !== documentId || $[41] !== schemaType ? (t123 = /* @__PURE__ */ jsxRuntime.jsx(DraftLiveEditBanner, { displayed, documentId, schemaType }), $[39] = displayed, $[40] = documentId, $[41] = schemaType, $[42] = t123) : t123 = $[42], t11 = t123;
      break bb1;
    }
    ...
    let t122;
    $[43] !== permissions?.granted || $[44] !== requiredPermission ? (t122 = !permissions?.granted && /* @__PURE__ */ jsxRuntime.jsx(InsufficientPermissionBanner, { requiredPermission }), $[43] = permissions?.granted, $[44] = requiredPermission, $[45] = t122) : t122 = $[45];
    let t132, t142, t15;
    $[46] === Symbol.for("react.memo_cache_sentinel") ? (t132 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t142 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t15 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), $[46] = t132, $[47] = t142, $[48] = t15) : (t132 = $[46], t142 = $[47], t15 = $[48]);
    let t16;
    $[49] !== t122 ? (t16 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t122,
      t132,
      t142,
      t15
    ] }), $[49] = t122, $[50] = t16) : t16 = $[50], t11 = t16;
  }
  const banners = t11;
  let t12;
  $[51] !== activeViewNode || $[52] !== banners || $[53] !== documentScrollElement || $[54] !== features.resizablePanes || $[55] !== formViewHidden || $[56] !== inspectDialog || $[57] !== layoutCollapsed || $[58] !== margins || $[59] !== portalElement || $[60] !== showInspector ? (t12 = (features.resizablePanes || !showInspector) && /* @__PURE__ */ jsxRuntime.jsx(DocumentBox, { flex: 2, overflow: "hidden", children: /* @__PURE__ */ jsxRuntime.jsx(ui.PortalProvider, { element: portalElement, __unstable_elements: {
  ...
  ] }) }) }) }), $[51] = activeViewNode, $[52] = banners, $[53] = documentScrollElement, $[54] = features.resizablePanes, $[55] = formViewHidden, $[56] = inspectDialog, $[57] = layoutCollapsed, $[58] = margins, $[59] = portalElement, $[60] = showInspector, $[61] = t12) : t12 = $[61];
  let t13;
  $[62] !== documentId || $[63] !== rootElement || $[64] !== schemaType || $[65] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[62] = documentId, $[63] = rootElement, $[64] = schemaType, $[65] = showInspector, $[66] = t13) : t13 = $[66];
  let t14;
  return $[67] !== t12 || $[68] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t12,
    t13
  ] }) }), $[67] = t12, $[68] = t13, $[69] = t14) : t14 = $[69], t14;
};
...
function ActionMenuButton(props) {
  ...
  $[1] !== actionStates || $[2] !== disabled || $[3] !== idPrefix || $[4] !== t ? (t2 = (t32) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.MenuButton, { id: `${idPrefix}-action-menu`, button: /* @__PURE__ */ jsxRuntime.jsx(sanity.ContextMenuButton, { "aria-label": t("buttons.action-menu-button.aria-label"), disabled, "data-testid": "action-menu-button", size: "large", tooltipProps: {
...
const TooltipContent$1 = (t0) => {
  ...
  if (release.metadata.releaseType === "scheduled") {
    ...
    let t1;
    return $[4] !== isActive || $[5] !== release || $[6] !== t ? (t1 = release.metadata.intendedPublishAt && /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: isActive ? /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { t, i18nKey: "release.chip.tooltip.intended-for-date", values: {
  ...
  if (release.metadata.releaseType === "undecided") {
    ...
    let t2;
    return $[10] !== t1 ? (t2 = /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: t1 }), $[10] = t1, $[11] = t2) : t2 = $[11], t2;
  }
  return null;
}, DATE_TIME_FORMAT = {
  dateStyle: "medium",
  ...
  const {
    ...
    data: archivedReleases
  } = sanity.useArchivedReleases(), schema = sanity.useSchema(), {
    editState,
    displayed,
    documentType,
    documentId
    ...
    documentId
  }), isCreatingDocument = displayed && !displayed._createdAt, filteredReleases = React.useMemo(() => {
  ...
  }, [archivedReleases, isCreatingDocument, displayed?._id, documentVersions, params?.historyVersion, releases, selectedReleaseId]), handlePerspectiveChange = React.useCallback((perspective) => () => {
    setPerspective(perspective);
  }, [setPerspective]), schemaType = schema.get(documentType), isLiveEdit = schemaType ? isLiveEditEnabled(schemaType) : !1, isPublishedChipDisabled = React.useMemo(() => isLiveEdit && !selectedReleaseId ? !1 : !editState?.published, [isLiveEdit, selectedReleaseId, editState?.published]), getReleaseChipState = React.useCallback((release_0) => {
    if (!params?.historyVersion) return {
      selected: sanity.getReleaseIdFromReleaseDocumentId(release_0._id) === sanity.getVersionFromId(displayed?._id || "")
    };
    const isReleaseHistoryMatch = sanity.getReleaseIdFromReleaseDocumentId(release_0._id) === params.historyVersion;
    return {
  ...
  }, [displayed?._id, editState?.published, isPublishSelected, params?.historyVersion, selectedPerspectiveName]), isDraftDisabled = React.useMemo(() => editState?.draft ? !1 : !!(isCreatingDocument && selectedReleaseId || isLiveEdit), [editState?.draft, isCreatingDocument, isLiveEdit, selectedReleaseId]);
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    ...
    displayed && filteredReleases.currentReleases?.map((release_1) => /* @__PURE__ */ jsxRuntime.jsx(sanity.VersionChip, { tooltipContent: /* @__PURE__ */ jsxRuntime.jsx(TooltipContent$1, { release: release_1 }), ...getReleaseChipState(release_1), onClick: handlePerspectiveChange(sanity.getReleaseIdFromReleaseDocumentId(release_1._id)), text: release_1.metadata.title || t("release.placeholder-untitled-release"), tone: sanity.getReleaseTone(release_1), locked: sanity.isReleaseScheduledOrScheduling(release_1), contextValues: {
      documentId: displayed?._id || "",
      menuReleaseId: release_1._id,
      releases: filteredReleases.notCurrentReleases,
      releasesLoading: loading,
      documentType,
      fromRelease: sanity.getReleaseIdFromReleaseDocumentId(release_1._id),
  ...
  const {
    ...
    menuItems,
    menuItemGroups
  }), [onMenuAction, fieldActions, menuItemGroups, menuItems]), menuButtonNodes = React.useMemo(() => menuNodes.filter(isMenuNodeButton), [menuNodes]), contextMenuNodes = React.useMemo(() => menuNodes.filter(isNotMenuNodeButton), [menuNodes]), showTabs = views2.length > 1, {
    collapsed,
    isLast
    ...
    states
  }) => /* @__PURE__ */ jsxRuntime.jsx(DocumentPanelHeaderActionDialogDeferred, { contextMenuNodes, setReferenceElement, referenceElement, states }), [contextMenuNodes, referenceElement]), title = React.useMemo(() => /* @__PURE__ */ jsxRuntime.jsx(DocumentHeaderTitle, {}), []), tabs = React.useMemo(() => showTabs && /* @__PURE__ */ jsxRuntime.jsx(DocumentHeaderTabs, {}), [showTabs]), backButton = React.useMemo(() => showBackButton && /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { as: BackLink2, "data-as": "a", icon: icons.ArrowLeftIcon, mode: "bleed", tooltipProps: {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { hidden: collapsed, style: {
      lineHeight: 0
    }, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { flex: 1, wrap: "wrap", gap: 1, padding: 3, paddingBottom: 0, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentPerspectiveList, {}) }),
      /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", padding: 3, paddingBottom: 0, children: renderedActions })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsx(PaneHeader$1, { border: !0, ref, loading: connectionState === "connecting" && !editState?.draft && !editState?.published, title, tabs, tabIndex, backButton })
  ] });
...
const STATUS_DICTIONARY = {
  ...
  minimal: !0,
  useTemporalPhrase: !0
}, MotionButton = framerMotion.motion.create(ui.Button), ButtonSkeleton = () => {
  ...
  const t4 = inspector?.name === HISTORY_INSPECTOR_NAME ? onHistoryClose : onHistoryOpen;
  let t5;
  $[2] !== author ? (t5 = author && /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
    margin: -5
  }, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.UserAvatar, { user: author, size: 0 }) }), $[2] = author, $[3] = t5) : t5 = $[3];
  let t6;
  $[4] !== t || $[5] !== translationKey ? (t6 = t(translationKey), $[4] = t, $[5] = translationKey, $[6] = t6) : t6 = $[6];
  let t7;
  $[7] !== relativeTime || $[8] !== t6 ? (t7 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Text, { muted: !0, size: 1, children: [
    t6,
    " ",
    relativeTime
  ] }), $[7] = relativeTime, $[8] = t6, $[9] = t7) : t7 = $[9];
  let t8;
  $[10] !== t5 || $[11] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", flex: "none", gap: 3, children: [
    t5,
    t7
  ] }), $[10] = t5, $[11] = t7, $[12] = t8) : t8 = $[12];
  let t9;
  return $[13] !== t4 || $[14] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(MotionButton, { "data-testid": "pane-footer-document-status", animate: t2, initial: t3, mode: "bleed", onClick: t4, padding: 2, muted: !0, children: t8 }), $[13] = t4, $[14] = t8, $[15] = t9) : t9 = $[15], t9;
}, FallbackStatus = () => {
  const {
    editState
  } = useDocumentPane(), {
...
function DocumentStatusLine() {
  ...
  let t5;
  if ($[12] !== lastUpdated || $[13] !== syncState.isSyncing ? (t5 = [syncState.isSyncing, lastUpdated], $[12] = lastUpdated, $[13] = syncState.isSyncing, $[14] = t5) : t5 = $[14], React.useLayoutEffect(t4, t5), status) {
    const t62 = status || void 0;
    let t7;
    return $[15] !== t62 ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusPulse, { status: t62 }), $[15] = t62, $[16] = t7) : t7 = $[16], t7;
  }
  if (eventsEnabled) {
    let t62;
    return $[17] === Symbol.for("react.memo_cache_sentinel") ? (t62 = /* @__PURE__ */ jsxRuntime.jsx(EventsStatus, {}), $[17] = t62) : t62 = $[17], t62;
  }
  let t6;
  return $[18] === Symbol.for("react.memo_cache_sentinel") ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(TimelineStatus, {}), $[18] = t6) : t6 = $[18], t6;
}
...
function DocumentStatusBar(props) {
  ...
  let t4;
  $[10] !== actions || $[11] !== actionsBoxRef || $[12] !== collapsed || $[13] !== shouldRender || $[14] !== showingRevision ? (t4 = shouldRender && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "stretch", gap: 1, justify: "space-between", paddingY: 2, paddingLeft: showingRevision ? 3 : 4, paddingRight: showingRevision ? 2 : 3, children: [
  ...
  let t5;
  $[16] !== t4 ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { direction: "column", ref: setRootElement, sizing: "border", children: t4 }), $[16] = t4, $[17] = t5) : t5 = $[17];
  let t6;
  return $[18] !== t3 || $[19] !== t5 ? (t6 = /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { tone: t3, children: t5 }), $[18] = t3, $[19] = t5, $[20] = t6) : t6 = $[20], t6;
}
...
function DocumentLayout() {
  const {
    ...
    collapsed: layoutCollapsed
  } = usePaneLayout(), zOffsets = sanity.useZIndex(), previewUrl = usePreviewUrl(value), createLinkMetadata = sanity.getSanityCreateLinkMetadata(value), {
  ...
  const [inspectorMenuItems, setInspectorMenuItems] = React.useState([]), [rootFieldActionNodes, setRootFieldActionNodes] = React.useState([]), footerRect = ui.useElementRect(footerElement), headerRect = ui.useElementRect(headerElement), footerHeight = footerRect?.height, headerHeight = headerRect?.height, currentMinWidth = DOCUMENT_PANEL_INITIAL_MIN_WIDTH + (inspector ? DOCUMENT_INSPECTOR_MIN_WIDTH : 0), minWidth = DOCUMENT_PANEL_MIN_WIDTH + (inspector ? DOCUMENT_INSPECTOR_MIN_WIDTH : 0), currentInspector = React.useMemo(() => inspectors2?.find((i) => i.name === inspector?.name), [inspectors2, inspector?.name]), hasValue = !!value, menuItems = React.useMemo(() => getMenuItems({
    ...
    previewUrl,
    t
  }), [currentInspector, features, hasValue, inspectorMenuItems, inspectors2, previewUrl, t]), handleKeyUp = React.useCallback((event) => {
  ...
  }, [onPathOpen, onFocus]), portalElements = React.useMemo(() => ({
  ...
  return schemaType ? /* @__PURE__ */ jsxRuntime.jsxs(sanity.GetFormValueProvider, { value, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(sanity.FieldActionsProvider, { actions: rootFieldActionNodes, path: EMPTY_ARRAY, children: /* @__PURE__ */ jsxRuntime.jsxs(DocumentActionShortcuts, { actionsBoxElement, as: Pane, currentMinWidth, "data-testid": "document-pane", flex: 2.5, id: paneKey, minWidth, onKeyUp: handleKeyUp, rootRef: setRootElement, children: [
      ...
      createLinkMetadata && sanity.isSanityCreateLinked(createLinkMetadata) && CreateLinkedBannerContent && /* @__PURE__ */ jsxRuntime.jsx(ShowWhenPaneOpen, { children: /* @__PURE__ */ jsxRuntime.jsx(Banner, { tone: "transparent", "data-test-id": "sanity-create-read-only-banner", content: /* @__PURE__ */ jsxRuntime.jsx(CreateLinkedBannerContent, { metadata: createLinkMetadata }) }) }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ui.PortalProvider, { __unstable_elements: portalElements, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.DialogProvider, { position: DIALOG_PROVIDER_POSITION, zOffset: zOffsets.portal, children: [
        StartInCreateBanner && /* @__PURE__ */ jsxRuntime.jsx(ShowWhenPaneOpen, { children: /* @__PURE__ */ jsxRuntime.jsx(StartInCreateBanner, { document: value, documentId, documentType: schemaType, documentReady: ready, isInitialValueLoading: !!isInitialValueLoading, panelPortalElementId: DOCUMENT_PANEL_PORTAL_ELEMENT }) }),
        /* @__PURE__ */ jsxRuntime.jsx(PaneFooter, { ref: setFooterElement, children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(DocumentStatusBar, { actionsBoxRef: setActionsBoxElement, createLinkMetadata }) }) })
      ] }) }),
...
const DocumentPaneProvider = React.memo((props) => {
  const {
    ...
    revisionId,
    lastNonDeletedRevId
  } = historyStore, schema = sanity.useSchema(), templates = sanity.useTemplates(), {
    setDocumentMeta
  } = sanity.useCopyPaste(), {
    __internal_tasks,
    document: {
  ...
  } = sanity.useSource(), telemetry2 = react.useTelemetry(), presenceStore = sanity.usePresenceStore(), paneRouter = usePaneRouter(), setPaneParams = paneRouter.setParams, {
    features
  } = useStructureTool(), {
    push: pushToast
  } = ui.useToast(), {
    ...
    title = null,
    views: viewsProp = []
  } = pane2, paneOptions = sanity.useUnique(options), documentIdRaw = paneOptions.id, documentId = sanity.getPublishedId(documentIdRaw), documentType = options.type, params = sanity.useUnique(paneRouter.params) || EMPTY_PARAMS$1, perspective = sanity.usePerspective(), {
    isReleaseLocked,
    selectedReleaseId,
    selectedPerspectiveName
  ...
  }), [documentType, paneOptions, params, panePayload, templates]), initialValueRaw = sanity.useInitialValue({
    documentId,
    documentType,
    templateName,
    templateParams,
    version: params.version
  }), initialValue = sanity.useUnique(initialValueRaw), isInitialValueLoading = initialValue.loading, {
    patch
  } = sanity.useDocumentOperation(documentId, documentType, selectedReleaseId), schemaType = schema.get(documentType), editState = sanity.useEditState(documentId, documentType, "default", selectedReleaseId), {
    validation: validationRaw
  } = sanity.useValidationStatus(documentId, documentType, selectedReleaseId), connectionState = sanity.useConnectionState(documentId, documentType, selectedReleaseId), liveEdit = !!schemaType?.liveEdit, value = React.useMemo(() => selectedReleaseId ? editState.version || editState.draft || editState.published || initialValue.value : selectedPerspectiveName && sanity.isPublishedPerspective(selectedPerspectiveName) ? editState.published || (liveEdit ? initialValue.value : {
    _id: documentId,
    _type: documentType
  }) : editState.draft || editState.published || initialValue.value, [documentId, documentType, editState.draft, editState.published, editState.version, initialValue.value, liveEdit, selectedPerspectiveName, selectedReleaseId]), [isDeleting, setIsDeleting] = React.useState(!1), getDocumentVersionType = React.useCallback(() => {
    let version;
    switch (!0) {
      case !!params.rev:
        version = "revision";
    ...
    return version;
  }, [selectedPerspectiveName, selectedReleaseId, params, value._id]), actionsPerspective = React.useMemo(() => getDocumentVersionType(), [getDocumentVersionType]), documentActionsProps = React.useMemo(() => ({
    ...
    schemaType: documentType,
    documentId
  }), [documentId, documentType, languageFilterResolver]), validation = sanity.useUnique(validationRaw), views2 = sanity.useUnique(viewsProp), [focusPath, setFocusPath] = React.useState(() => params.path ? PathUtils.fromString(params.path) : sanity.EMPTY_ARRAY), focusPathRef = React.useRef([]), activeViewId = params.view || views2[0] && views2[0].id || null, isDeleted = React.useMemo(() => timelineReady ? !editState?.draft && !editState?.published && !editState?.version && !isPristine : !1, [editState?.draft, editState?.published, editState?.version, isPristine, timelineReady]), previewUrl = usePreviewUrl(value), [presence, setPresence] = React.useState([]);
  React.useEffect(() => {
  ...
  const inspectors2 = React.useMemo(() => inspectorsResolver({
    documentId,
    documentType
  ...
  const currentInspector = inspectors2?.find((i) => i.name === inspectorName), resolvedChangesInspector = inspectors2.find((i_0) => i_0.name === HISTORY_INSPECTOR_NAME), changesOpen = currentInspector?.name === HISTORY_INSPECTOR_NAME, {
    t
  } = sanity.useTranslation(structureLocaleNamespace), inspectOpen = params.inspect === "on", compareValue = changesOpen ? sinceDocument : editState?.published || null, fieldActions = React.useMemo(() => schemaType ? fieldActionsResolver({
    documentId,
    documentType,
    schemaType
  }) : [], [documentId, documentType, fieldActionsResolver, schemaType]), ready = connectionState === "connected" && editState.ready && (!params.rev || timelineReady || !!timelineError), displayed = React.useMemo(() => onOlderRevision ? revisionDocument || {
    _id: value._id,
    _type: value._type
  } : value, [onOlderRevision, revisionDocument, value]), setTimelineRange = React.useCallback((newSince, newRev) => {
    setPaneParams({
      ...params,
      since: newSince,
      rev: newRev || void 0
    });
  }, [params, setPaneParams]), handleBlur = React.useCallback((blurredPath) => {
  ...
  }, [onFocusPath, setFocusPath]), closeInspector = React.useCallback((closeInspectorName) => {
  ...
  }, [currentInspector, inspectors2, params, setPaneParams]), openInspector = React.useCallback((nextInspectorName, paneParams) => {
  ...
  }, [currentInspector, inspectors2, params, setPaneParams]), handleHistoryClose = React.useCallback(() => {
  ...
  }, [features.reviewChanges, openInspector, resolvedChangesInspector]), handlePaneClose = React.useCallback(() => paneRouter.closeCurrent(), [paneRouter]), handlePaneSplit = React.useCallback(() => paneRouter.duplicateCurrent(), [paneRouter]), toggleLegacyInspect = React.useCallback((toggle = !inspectOpen) => {
    setPaneParams(toggle ? {
      ...params,
      inspect: "on"
    } : omit__default.default(params, "inspect"));
  }, [inspectOpen, params, setPaneParams]), handleMenuAction = React.useCallback((item) => {
    ...
    return !1;
  }, [t, closeInspector, handleHistoryOpen, inspectorName, inspectors2, openInspector, previewUrl, toggleLegacyInspect, pushToast, telemetry2]), handleLegacyInspectClose = React.useCallback(() => toggleLegacyInspect(!1), [toggleLegacyInspect]), [openPath, onSetOpenPath] = React.useState([]), [fieldGroupState, onSetFieldGroupState] = React.useState(), [collapsedPaths, onSetCollapsedPath] = React.useState(), [collapsedFieldSets, onSetCollapsedFieldSets] = React.useState(), handleOnSetCollapsedPath = React.useCallback((path, collapsed) => {
    onSetCollapsedPath((prevState) => sanity.setAtPath(prevState, path, collapsed));
  }, []), handleOnSetCollapsedFieldSet = React.useCallback((path_0, collapsed_0) => {
    onSetCollapsedFieldSets((prevState_0) => sanity.setAtPath(prevState_0, path_0, collapsed_0));
  }, []), handleSetActiveFieldGroup = React.useCallback((path_1, groupName) => onSetFieldGroupState((prevState_1) => sanity.setAtPath(prevState_1, path_1, groupName)), []), requiredPermission = value._createdAt ? "update" : "create", docId = value._id ? value._id : "dummy-id", docPermissionsInput = React.useMemo(() => ({
    ...value,
  ...
  }), isCreateLinked = sanity.isSanityCreateLinkedDocument(value), isNonExistent = !value?._id, readOnly = React.useMemo(() => {
    ...
    return liveEdit && editState.draft?._id || !liveEdit && selectedPerspectiveName === "published" || selectedReleaseId && sanity.getVersionFromId(value._id) !== selectedReleaseId ? !0 : !ready || revisionId !== null || hasNoPermission || updateActionDisabled || createActionDisabled || reconnecting || isLocked || isDeleting || isDeleted || isCreateLinked || isReleaseLocked;
  }, [isPermissionsLoading, permissions?.granted, schemaType, isNonExistent, connectionState, editState.transactionSyncLock?.enabled, editState.draft?._id, liveEdit, selectedPerspectiveName, selectedReleaseId, value._id, ready, revisionId, isDeleting, isDeleted, isCreateLinked, isReleaseLocked]), patchRef = React.useRef(() => {
  ...
  const formState = sanity.useFormState({
    schemaType,
  ...
  const setOpenPath = React.useCallback((path_2) => {
    sanity.getExpandOperations(formStateRef.current, path_2).forEach((op) => {
      op.type === "expandPath" && onSetCollapsedPath((prevState_2) => sanity.setAtPath(prevState_2, op.path, !1)), op.type === "expandFieldSet" && onSetCollapsedFieldSets((prevState_3) => sanity.setAtPath(prevState_3, op.path, !1)), op.type === "setSelectedGroup" && onSetFieldGroupState((prevState_4) => sanity.setAtPath(prevState_4, op.path, op.groupName));
    }), onSetOpenPath(path_2);
  }, [formStateRef]), updatePresence = React.useCallback((nextFocusPath, payload) => {
  ...
  }, [presenceStore, value._id]), updatePresenceThrottled = React.useMemo(() => throttle__default.default(updatePresence, 1e3, {
    leading: !0,
    trailing: !0
  }), [updatePresence]), handleFocus = React.useCallback((_nextFocusPath, payload_0) => {
    const nextFocusPath_0 = PathUtils.pathFor(_nextFocusPath);
    nextFocusPath_0 !== focusPathRef.current && (setFocusPath(PathUtils.pathFor(nextFocusPath_0)), setOpenPath(PathUtils.pathFor(nextFocusPath_0.slice(0, -1))), focusPathRef.current = nextFocusPath_0, onFocusPath?.(nextFocusPath_0)), updatePresenceThrottled(nextFocusPath_0, payload_0);
  }, [onFocusPath, setOpenPath, updatePresenceThrottled]), documentPane = React.useMemo(() => ({
    actions,
    activeViewId,
    badges,
    changesOpen,
  ...
  return React.useEffect(() => {
    if (ready && params.path) {
      const {
        path: path_3,
        ...restParams
      } = params, pathFromUrl = PathUtils.resolveKeyedPath(formStateRef.current?.value, PathUtils.fromString(path_3));
      disableBlurRef.current = !0, deepCompare__default.default(focusPathRef.current, pathFromUrl) || (setFocusPath(pathFromUrl), setOpenPath(pathFromUrl), focusPathRef.current = pathFromUrl, onFocusPath?.(pathFromUrl));
...
const DocumentPaneWithLegacyTimelineStore = (props) => {
  const $ = reactCompilerRuntime.c(20), {
    pane: pane2
  } = props, paneRouter = usePaneRouter(), options = usePaneOptions(pane2.options, paneRouter.params), params = paneRouter.params || EMPTY_PARAMS$1, [timelineError, setTimelineError] = React.useState(null);
  let t0;
...
function useResetHistoryParams() {
  ...
  }, t3 = [selectedPerspectiveName, updateHistoryParams], $[3] = selectedPerspectiveName, $[4] = updateHistoryParams, $[5] = t2, $[6] = t3) : (t2 = $[5], t3 = $[6]), React.useEffect(t2, t3);
  let t4, t5;
  $[7] === Symbol.for("react.memo_cache_sentinel") ? (t4 = () => (isMounted.current = !0, () => {
    isMounted.current = !1;
  }), t5 = [], $[7] = t4, $[8] = t5) : (t4 = $[7], t5 = $[8]), React.useEffect(t4, t5);
}
...
function DocumentPaneInner(props) {
  ...
  let t11;
  $[43] !== ReferenceChildLink2 || $[44] !== activePath || $[45] !== handleEditReference || $[46] !== t10 || $[47] !== templatePermissions ? (t11 = /* @__PURE__ */ jsxRuntime.jsx(sanity.ReferenceInputOptionsProvider, { EditReferenceLinkComponent: ReferenceChildLink2, onEditReference: handleEditReference, initialValueTemplateItems: templatePermissions, activePath, children: t10 }), $[43] = ReferenceChildLink2, $[44] = activePath, $[45] = handleEditReference, $[46] = t10, $[47] = templatePermissions, $[48] = t11) : t11 = $[48];
  let t12;
  return $[49] !== providerProps || $[50] !== t11 || $[51] !== t8 ? (t12 = /* @__PURE__ */ jsxRuntime.jsx(DocumentPaneProviderWrapper, { ...providerProps, children: t11 }, t8), $[49] = providerProps, $[50] = t11, $[51] = t8, $[52] = t12) : t12 = $[52], t12;
}
function _temp$3(t0) {
  const {
    children
...
function removePublishedWithDrafts(documents) {
  return sanity.collate(documents).map((entry) => {
    const doc = entry.draft || entry.published, isVersion = doc?.id && sanity.isVersionId(doc._id), hasDraft = !!entry.draft;
    return {
      ...doc,
...
const VISIBLE_COLUMN_LIMIT = 5, PreviewCell = (props) => {
  const {
    ...
    row,
    schemaType
  } = props, title = "Document title", previewStateObservable = React.useMemo(() => sanity.getPreviewStateObservable(documentPreviewStore, schemaType, row.original._id, title), [documentPreviewStore, row.original._id, schemaType]), {
    draft,
    published,
    isLoading
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
    /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatusIndicator, { draft, published, versions: void 0 }),
...
async function resolveTypeForDocument(getClient, id) {
  ...
  return (await getClient(sanity.DEFAULT_STUDIO_CLIENT_OPTIONS).fetch(query, {
    documentId,
    draftId
  }, {
...
function getIntentState(intent, params, routerState, payload) {
  const panes = routerState?.panes || [], activePanes = state.activePanes || [], editDocumentId = params.id || uuid.uuid(), isTemplate = intent === "create" && params.template, isVersion = intent === "create" && params.version;
  for (let i = activePanes.length - 1; i >= 0; i--) {
    ...
    pane2.type === "documentList" && pane2.schemaTypeName === params.type && pane2.options.filter === "_type == $type")) {
      const paneParams = EMPTY_PARAMS$2;
      return isTemplate && (paneParams.template = params.template), isVersion && (paneParams.version = params.version), {
...
function PublishedEventMenu(t0) {
  ...
  $[22] !== VersionBadge || $[23] !== event.release || $[24] !== event.versionRevisionId || $[25] !== handleOpenDraftDocument || $[26] !== handleOpenReleaseDocument || $[27] !== t ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(ui.Menu, { padding: 1, children: event.release ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(router$1.IntentLink, { intent: sanity.RELEASES_INTENT, params: {
      ...
      textDecoration: "none"
    }, children: /* @__PURE__ */ jsxRuntime.jsx(ui.MenuItem, { padding: 3, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, style: {
      textDecoration: "none"
      ...
      VersionBadge: (t102) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs(VersionBadge, { children: [
          children_0,
          " "
        ] });
      }
    ...
    /* @__PURE__ */ jsxRuntime.jsx(ui.MenuItem, { onClick: handleOpenReleaseDocument, children: /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { align: "center", children: /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.Translate, { components: {
      VersionBadge: (t112) => {
        const {
          children: children_1
        } = t112;
...
function ChangesTabs(props) {
  ...
  let t16;
  $[30] !== props.onClose || $[31] !== t12 || $[32] !== t15 ? (t16 = /* @__PURE__ */ jsxRuntime.jsx(ui.Box, { flex: "none", children: /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.Button, { "aria-label": t12, icon: icons.CloseIcon, mode: "bleed", onClick: t13, tooltipProps: t15 }) }), $[30] = props.onClose, $[31] = t12, $[32] = t15, $[33] = t16) : t16 = $[33];
  let t17;
  $[34] !== t11 || $[35] !== t16 ? (t17 = /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", padding: 3, gap: 2, children: [
    t11,
    t16
