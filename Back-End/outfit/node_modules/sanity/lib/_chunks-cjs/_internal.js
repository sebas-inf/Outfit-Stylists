...
`, appBuildCommand = {
  ...
  action: async (args, context, overrides) => (await getBuildAction$1())(args, context, overrides),
  helpText: helpText$C
};
async function getBuildAction$1() {
...
`, appDevCommand = {
  ...
  action: async (args, context) => (await getDevAction$1())(args, context),
  helpText: helpText$B
};
async function getDevAction$1() {
  return (await Promise.resolve().then(function() {
    return require("./devAction.js");
  })).default;
}
const isInteractive = process.stdout.isTTY && process.env.TERM !== "dumb" && !("CI" in process.env), helpText$A = `
Notes
  Changing the hostname or port number might require a new entry to the CORS-origins allow list.
...
async function getPreviewAction$2() {
  return (await Promise.resolve().then(function() {
...
const MIGRATIONS_DIRECTORY = "migrations", MIGRATION_SCRIPT_EXTENSIONS = ["mjs", "js", "ts", "cjs"], minimalAdvanced = ({
  migrationName,
  documentTypes
