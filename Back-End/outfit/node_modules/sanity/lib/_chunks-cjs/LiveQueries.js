...
function LiveQueries(props) {
  ...
  let t8;
  $[20] !== t7 ? (t8 = [...t7], $[20] = t7, $[21] = t8) : t8 = $[21];
  let t9;
  return $[22] !== client || $[23] !== comlink$1 || $[24] !== dataset || $[25] !== liveDocument || $[26] !== liveEvents.messages || $[27] !== liveEvents.resets || $[28] !== projectId || $[29] !== t8 ? (t9 = /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, { children: t8.map((t10) => {
    const [key, t11] = t10, {
      query,
      params,
      perspective
  ...
  }) }), $[22] = client, $[23] = comlink$1, $[24] = dataset, $[25] = liveDocument, $[26] = liveEvents.messages, $[27] = liveEvents.resets, $[28] = projectId, $[29] = t8, $[30] = t9) : t9 = $[30], t9;
}
function _temp() {
}
