...
`, Button = React.forwardRef(function(t0, ref) {
  ...
  let t2;
  $[6] !== footer || $[7] !== props || $[8] !== t ? (t2 = (footer?.confirmButton || footer?.cancelButton) && /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { width: "full", gap: 3, justify: "flex-end", padding: 3, children: [
