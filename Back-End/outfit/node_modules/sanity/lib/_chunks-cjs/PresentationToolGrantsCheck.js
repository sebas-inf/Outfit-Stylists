...
const PostMessageFeatures = (props) => {
  ...
  let t0, t1;
  return $[0] !== comlink2 ? (t0 = () => comlink2.on("visual-editing/features", _temp$7), t1 = [comlink2], $[0] = comlink2, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), React.useEffect(t0, t1), null;
};
...
function DocumentListPane(props) {
  ...
  if ($[0] !== mainDocumentState?.document?._id || $[1] !== refs) {
    let t22;
    $[3] !== mainDocumentState?.document?._id ? (t22 = (r) => sanity.getPublishedId(r._id) !== mainDocumentState?.document?._id, $[3] = mainDocumentState?.document?._id, $[4] = t22) : t22 = $[4], t1 = refs.filter(t22).map(_temp$4), $[0] = mainDocumentState?.document?._id, $[1] = refs, $[2] = t1;
  } else
    t1 = $[2];
  t0 = t1;
  const ids = t0;
  ...
  const handleRetry = t6, [structureParams] = React.useState(_temp2$1);
  let t7;
...
function ContentEditor(props) {
  ...
  bb0: {
    ...
    let t8;
    $[15] !== schemaType || $[16] !== t52 || $[17] !== t7 ? (t8 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { ...t52, schemaType, status: t7 }), $[15] = schemaType, $[16] = t52, $[17] = t7, $[18] = t8) : t8 = $[18], t3 = t8;
  }
  const preview = t3;
...
function PreviewHeader(props) {
  const $ = reactCompilerRuntime.c(7), renderDefault = _temp$2, HeaderComponent = props.options?.component;
  let t0;
...
function usePresentationPreviewHeader(props) {
  const $ = reactCompilerRuntime.c(2);
  let t0;
  return $[0] !== props ? (t0 = () => /* @__PURE__ */ jsxRuntime.jsx(PreviewHeader, { ...props }), $[0] = props, $[1] = t0) : t0 = $[1], t0;
}
const MotionFlex = framerMotion.motion.create(ui.Flex), Preview = React.memo(React.forwardRef(function(props, forwardedRef) {
  ...
  const {
    ...
    devMode
  } = presentation.usePresentationTool(), prefersReducedMotion = ui.usePrefersReducedMotion(), ref = React.useRef(null), PreviewHeader2 = usePresentationPreviewHeader({
    ...props,
    iframeRef: ref,
    options: header
  });
...
function useMainDocument(props) {
  const {
    ...
    state: routerState
  } = router.useRouter(), client2 = sanity.useClient({
    apiVersion: presentation.API_VERSION
  }), relativeUrl = path || routerState._searchParams?.find(([key]) => key === "preview")?.[1] || "", [mainDocumentState, setMainDocumentState] = React.useState(void 0), mainDocumentIdRef = React.useRef(void 0), handleResponse = useEffectEvent.useEffectEvent((doc, url) => {
  ...
  }, [client2, handleResponse, previewUrl, relativeUrl, resolvers]), mainDocumentState;
}
