...
function RouterProvider(props) {
  ...
  }, [routerProp, state]), handleNavigateStickyParams = useCallback((params_0, options = {}) => {
  ...
  }, [onNavigate, resolvePathFromState, state]), navigate = useCallback((nextState_0, options_0 = {}) => {
    onNavigate({
      path: resolvePathFromState(nextState_0),
      replace: options_0.replace
    });
  }, [onNavigate, resolvePathFromState]), navigateIntent = useCallback((intentName_0, params_1, options_1 = {}) => {
    onNavigate({
