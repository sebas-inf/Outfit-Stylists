...
function LiveQueries(props) {
  ...
  let t9;
  return $[22] !== client || $[23] !== comlink || $[24] !== dataset || $[25] !== liveDocument || $[26] !== liveEvents.messages || $[27] !== liveEvents.resets || $[28] !== projectId || $[29] !== t8 ? (t9 = /* @__PURE__ */ jsx(Fragment, { children: t8.map((t10) => {
    const [key, t11] = t10, {
      query,
      params,
      perspective
  ...
  }) }), $[22] = client, $[23] = comlink, $[24] = dataset, $[25] = liveDocument, $[26] = liveEvents.messages, $[27] = liveEvents.resets, $[28] = projectId, $[29] = t8, $[30] = t9) : t9 = $[30], t9;
}
function _temp() {
}
